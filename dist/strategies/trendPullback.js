 ...
 */
class TrendPullbackStrategy extends base_1.BaseStrategy {
    name = 'Trend Pullback';
    supportedRegimes = ['TREND_UP', 'TREND_DOWN'];
    analyze(data, regime) {
        ...
        const confirmBear = (0, indicators_1.isBearishEngulfing)(candles5m.slice(-2)) ||
            (0, indicators_1.isBearishPin)(lastCandle5m);
        ...
        components.liquidity = (0, indicators_1.isVolumeSpike)(candles5m.slice(-20), 1.2) ? 10 : 5;
        // Slippage risk (0-5)
